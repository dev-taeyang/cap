...
HTMLCollection.prototype.forEach = Array.prototype.forEach;
images.forEach((img, i) => img.setAttribute('src', `/images/main-header-banner0${i+1}.png`));

banner.style.transform = `translate(-768px)`;

banner.appendChild(lastImage);
lastImage.setAttribute('src', `/images/main-header-banner01.png`);

banner.insertBefore(firstImage, document.querySelector(".main-header-banner img"));
firstImage.setAttribute('src', `/images/main-header-banner0${images.length}.png`);
